...
/**
 * DigiFusion before archive content.
 */
do_action( 'digifusion_before_archive_content' );

// Check if a custom builder template should be used
...
/**
 * DigiFusion after archive content.
 */
do_action( 'digifusion_after_archive_content' );
