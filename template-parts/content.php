...
<?php
/**
 * DigiFusion before post.
 */
do_action( 'digifusion_before_post' );
?>

<article id="post-<?php the_ID(); ?>" <?php post_class( 'digi-post-card' ); ?> <?php echo wp_kses_post( digifusion_get_schema_markup('blog-post') ); ?>>
	<?php
	/**
	 * DigiFusion before post inner.
	 */
	do_action( 'digifusion_before_post_inner' );
	?>
	...
	if ( has_post_thumbnail() ) {
		...
		<?php
		/**
		 * DigiFusion before post image.
		 */
		do_action( 'digifusion_before_post_image' );
		?>
		...
		<?php
		/**
		 * DigiFusion after post image.
		 */
		do_action( 'digifusion_after_post_image' );
		?>
		<?php
	}
	?>
	...
	<div class="digi-post-content">
		<?php
		/**
		 * DigiFusion before post content inner.
		 */
		do_action( 'digifusion_before_post_content_inner' );
		?>
		...
		<?php
		/**
		 * DigiFusion after post meta.
		 */
		do_action( 'digifusion_after_post_meta' );
		?>
		...
		<?php
		/**
		 * DigiFusion after post title.
		 */
		do_action( 'digifusion_after_post_title' );
		?>
		...
		<?php
		/**
		 * DigiFusion after post content inner.
		 */
		do_action( 'digifusion_after_post_content_inner' );
		?>
	</div>
	
	<?php
	/**
	 * DigiFusion after post inner.
	 */
	do_action( 'digifusion_after_post_inner' );
	?>
</article>

<?php
/**
 * DigiFusion after post.
 */
do_action( 'digifusion_after_post' );
?>